...
,p_default_application_id=>73506
...
prompt APPLICATION 73506 - F15E6FinalMobile
--
-- Application Export:
--   Application:     73506
--   Name:            F15E6FinalMobile
--   Date and Time:   17:56 Monday November 23, 2015
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,73506)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'CS347_CANNATA')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'F15E6FinalMobile')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_73506')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'7D17D4546DEB997030BB75727A84E1C9D60CBB276354C03813D0FE7DD48D50CF'
...
,p_authentication_id=>wwv_flow_api.id(18155479685044683470)
,p_application_tab_set=>0
,p_logo_image=>'TEXT:F15E6FinalMobile'
...
,p_last_upd_yyyymmddhh24miss=>'20151123023231'
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(18155469507324683405)
,p_name=>'Mobile Navigation Menu'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(18155480744395683481)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(18163541767838102889)
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'Pokedex'
,p_list_item_link_target=>'f?p=&APP_ID.:3:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'#WORKSPACE_IMAGES#Kanto_Pokédex_Infobox.png'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(18155469260530683405)
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(18155469309671683405)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(18155469410985683405)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(18155479444421683467)
,p_icon_sequence=>200
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(18159084618248036205)
,p_lov_name=>'POKEMON'
,p_lov_query=>'"MATCH (a:pokemon) RETURN a.poke_name, a.poke_id"'
);
end;
/
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(18155479741337683472)
,p_name=>' Breadcrumb'
);
end;
/
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(18155469636583683406)
,p_theme_id=>51
,p_name=>'Dialog'
,p_is_popup=>true
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(18155469833383683412)
,p_theme_id=>51
,p_name=>'Page'
,p_is_popup=>false
,p_header_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18155469933129683413)
,p_page_template_id=>wwv_flow_api.id(18155469833383683412)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18155470163931683413)
,p_page_template_id=>wwv_flow_api.id(18155469833383683412)
,p_name=>'Header Bar'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18155470274766683413)
,p_page_template_id=>wwv_flow_api.id(18155469833383683412)
,p_name=>'Footer Bar'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(18155470745250683417)
,p_theme_id=>51
,p_name=>'Popup'
,p_is_popup=>false
,p_header_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(18155473550732683434)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(18155477866379683441)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18155470848963683417)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18155471055924683422)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18155471166365683422)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18155471280301683422)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18155471353414683422)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18155471499661683422)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18155471543758683422)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18155471601991683423)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18155471708056683423)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18155471844568683423)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18155471968019683423)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18155472030161683423)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18155472189343683423)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18155472273999683423)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(18155472570715683426)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(18155472765091683430)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(18155472828560683430)
,p_list_template_current=>'<li data-theme="b"><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(18155472994055683431)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(18155473034054683431)
,p_list_template_current=>'<li data-theme="b"><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(18155472341416683424)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(18155473145988683431)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(18155473342565683433)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(18155473485504683433)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(18155478386723683448)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(18155478144861683442)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(18155479037504683458)
,p_theme_id=>51
,p_theme_name=>'Mobile'
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(18155469833383683412)
,p_default_dialog_template=>wwv_flow_api.id(18155469636583683406)
,p_error_template=>wwv_flow_api.id(18155469833383683412)
,p_printer_friendly_template=>wwv_flow_api.id(18155469833383683412)
,p_login_template=>wwv_flow_api.id(18155469833383683412)
,p_default_button_template=>wwv_flow_api.id(18155477866379683441)
,p_default_region_template=>wwv_flow_api.id(18155472030161683423)
,p_default_chart_template=>wwv_flow_api.id(18155472030161683423)
,p_default_form_template=>wwv_flow_api.id(18155472030161683423)
,p_default_reportr_template=>wwv_flow_api.id(18155472273999683423)
,p_default_tabform_template=>wwv_flow_api.id(18155472030161683423)
,p_default_wizard_template=>wwv_flow_api.id(18155472030161683423)
,p_default_irr_template=>wwv_flow_api.id(18155472030161683423)
,p_default_report_template=>wwv_flow_api.id(18155472341416683424)
,p_default_label_template=>wwv_flow_api.id(18155473342565683433)
,p_default_calendar_template=>wwv_flow_api.id(18155478144861683442)
,p_default_list_template=>wwv_flow_api.id(18155472828560683430)
,p_default_nav_list_template=>wwv_flow_api.id(18155472765091683430)
,p_default_top_nav_list_temp=>wwv_flow_api.id(18155472765091683430)
,p_default_side_nav_list_temp=>wwv_flow_api.id(18155473034054683431)
,p_default_nav_list_position=>'SIDE'
,p_default_dialogbtnr_template=>wwv_flow_api.id(18155470848963683417)
,p_default_dialogr_template=>wwv_flow_api.id(18155472030161683423)
,p_default_option_label=>wwv_flow_api.id(18155473342565683433)
,p_default_header_template=>wwv_flow_api.id(18155471708056683423)
,p_default_footer_template=>wwv_flow_api.id(18155471543758683422)
,p_default_required_label=>wwv_flow_api.id(18155473485504683433)
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(18155478572777683451)
,p_theme_id=>51
,p_name=>'Blue'
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(18155478630424683451)
,p_theme_id=>51
,p_name=>'Dark'
,p_css_file_urls=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(18155478799250683451)
,p_theme_id=>51
,p_name=>'Default'
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(18155478846410683451)
,p_theme_id=>51
,p_name=>'Red'
,p_css_file_urls=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(18155470309883683415)
,p_theme_id=>51
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(18155473618521683436)
,p_theme_id=>51
,p_name=>'ICON_BUTTON'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(18155474141557683437)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155470490332683416)
,p_theme_id=>51
,p_name=>'OVERLAY'
...
,p_group_id=>wwv_flow_api.id(18155470309883683415)
,p_template_types=>'PAGE'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155470541982683417)
,p_theme_id=>51
,p_name=>'PUSH'
,p_display_name=>'Push'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155470691524683417)
,p_theme_id=>51
,p_name=>'REVEAL'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155473785526683436)
,p_theme_id=>51
,p_name=>'ICON_ACTION'
,p_display_name=>'Action'
,p_display_sequence=>100
,p_button_template_id=>wwv_flow_api.id(18155473550732683434)
,p_css_classes=>'ui-icon-action'
,p_group_id=>wwv_flow_api.id(18155473618521683436)
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155473853673683436)
,p_theme_id=>51
,p_name=>'ICON_ALERT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155473950865683437)
,p_theme_id=>51
,p_name=>'ICON_BACK'
,p_display_name=>'Back'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155474008972683437)
,p_theme_id=>51
,p_name=>'ICON_BARS'
,p_display_name=>'Bars'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155474272343683437)
,p_theme_id=>51
,p_name=>'ICON_BOTTOM'
...
,p_group_id=>wwv_flow_api.id(18155474141557683437)
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155474301102683437)
,p_theme_id=>51
,p_name=>'ICON_BULLETS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155474489790683437)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155474588508683437)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155474652309683437)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155474793683683437)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155474866750683437)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155474998899683437)
,p_theme_id=>51
,p_name=>'ICON_CHECK'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155475066263683437)
,p_theme_id=>51
,p_name=>'ICON_CLOCK'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155475194709683437)
,p_theme_id=>51
,p_name=>'ICON_CLOUD'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155475214041683437)
,p_theme_id=>51
,p_name=>'ICON_COMMENT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155475382767683437)
,p_theme_id=>51
,p_name=>'ICON_DELETE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155475471019683437)
,p_theme_id=>51
,p_name=>'ICON_EDIT'
,p_display_name=>'Edit'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155475596172683437)
,p_theme_id=>51
,p_name=>'ICON_GEAR'
,p_display_name=>'Gear'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155475618782683438)
,p_theme_id=>51
,p_name=>'ICON_GRID'
,p_display_name=>'Grid'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155475770727683438)
,p_theme_id=>51
,p_name=>'ICON_HOME'
,p_display_name=>'Home'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155475896215683438)
,p_theme_id=>51
,p_name=>'ICON_INFO'
,p_display_name=>'Info'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155475912346683438)
,p_theme_id=>51
,p_name=>'ICON_LEFT'
,p_display_name=>'Left'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155476013056683438)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155476119063683438)
,p_theme_id=>51
,p_name=>'ICON_LOCK'
,p_display_name=>'Lock'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155476233446683438)
,p_theme_id=>51
,p_name=>'ICON_MAIL'
,p_display_name=>'Mail'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155476377802683438)
,p_theme_id=>51
,p_name=>'ICON_MINUS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155476404957683438)
,p_theme_id=>51
,p_name=>'ICON_PHONE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155476590015683438)
,p_theme_id=>51
,p_name=>'ICON_PLUS'
,p_display_name=>'Plus'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155476626728683438)
,p_theme_id=>51
,p_name=>'ICON_POWER'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155476763027683438)
,p_theme_id=>51
,p_name=>'ICON_REFRESH'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155476870741683438)
,p_theme_id=>51
,p_name=>'ICON_RIGHT'
,p_display_name=>'Right'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155476975606683438)
,p_theme_id=>51
,p_name=>'ICON_SEARCH'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155477194781683441)
,p_theme_id=>51
,p_name=>'ICON_STAR'
,p_display_name=>'Star'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155477201278683441)
,p_theme_id=>51
,p_name=>'ICON_TAG'
,p_display_name=>'Tag'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155477340920683441)
,p_theme_id=>51
,p_name=>'ICON_TOP'
,p_display_name=>'Top'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155477447572683441)
,p_theme_id=>51
,p_name=>'ICON_USER'
,p_display_name=>'User'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155477544134683441)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155477611840683441)
,p_theme_id=>51
,p_name=>'NO_TEXT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155477797001683441)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155477981824683441)
,p_theme_id=>51
,p_name=>'INLINE_BUTTON'
,p_display_name=>'Inline Button'
,p_display_sequence=>1
,p_button_template_id=>wwv_flow_api.id(18155477866379683441)
,p_css_classes=>'ui-btn-inline'
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(18155478047138683441)
,p_theme_id=>51
,p_name=>'ROUNDED_CORNERS'
,p_display_name=>'Rounded Corners'
,p_display_sequence=>1
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(18155479685044683470)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(18155479218797683462)
,p_ui_type_name=>'JQM_SMARTPHONE'
...
,p_global_page_id=>0
,p_navigation_list_id=>wwv_flow_api.id(18155469507324683405)
,p_navigation_list_position=>'SIDE'
,p_navigation_list_template_id=>wwv_flow_api.id(18155473034054683431)
...
wwv_flow_api.create_page(
 p_id=>0
,p_user_interface_id=>wwv_flow_api.id(18155479218797683462)
...
,p_last_upd_yyyymmddhh24miss=>'20151122213140'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18155480001756683475)
,p_plug_name=>'Header'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(18155471708056683423)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18155480563634683477)
,p_plug_name=>'Footer'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(18155471543758683422)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(18155480367534683477)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(18155480001756683475)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(18155480284090683476)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(18155480685812683477)
,p_name=>'open panel'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(18155480284090683476)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(18155480685812683477)
,p_event_id=>wwv_flow_api.id(18155480685812683477)
,p_event_result=>'TRUE'
...
,p_last_updated_by=>'MICHAELCANTU93@GMAIL.COM'
,p_last_upd_yyyymmddhh24miss=>'20151122213638'
);
end;
/
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'MICHAELCANTU93@GMAIL.COM'
,p_last_upd_yyyymmddhh24miss=>'20151123023218'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18157965468481805975)
,p_plug_name=>'doREST'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(18155472030161683423)
,p_plug_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'N'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18157993747881805993)
,p_plug_name=>'Results'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(18155472273999683423)
...
'select',
'jt1.poke_id poke_id,',
'jt2.poke_name poke_name,',
'jt3.descr descr,',
'jt4.image image,',
'jt5.poke_type poke_type',
'',
'into :P7_POKEID, :P7_POKENAME, :P7_DESCR, :P7_IMAGE, :P7_POKETYPE',
'from apex_collections t,',
'json_table(t.clob001, ''$.POKE_ID[*]'' COLUMNS rid for ordinality, poke_id number path ''$'') jt1,',
'json_table(t.clob001, ''$.POKE_NAME[*]'' COLUMNS rid for ordinality, poke_name varchar2(30) path ''$'') jt2,',
'json_table(t.clob001, ''$.DESCR[*]'' COLUMNS rid for ordinality, descr varchar2(1000) path ''$'') jt3,',
'json_table(t.clob001, ''$.IMAGE[*]'' COLUMNS rid for ordinality, image varchar2(150) path ''$'') jt4,',
'json_table(t.clob001, ''$.X0_1[*]'' COLUMNS rid for ordinality, poke_type varchar2(30) path ''$'') jt5',
'',
'where t.collection_name = ''P3_DOREST_RESULTS''',
'',
'and jt1.rid = jt2.rid and jt2.rid = jt3.rid and jt3.rid = jt4.rid and jt4.rid = jt5.rid;',
'',
'EXCEPTION',
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(18157965868932805977)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(18157965468481805975)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(18165449393341184213)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(18157965468481805975)
,p_button_name=>'Show'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(18165449515938184215)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18157967056020805982)
,p_name=>'P3_DB'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_api.id(18157965468481805975)
,p_prompt=>'Db'
...
,p_cSize=>30
,p_cMaxlength=>255
,p_field_template=>wwv_flow_api.id(18155473342565683433)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18157967860672805987)
,p_name=>'P3_USER'
,p_item_sequence=>2
,p_item_plug_id=>wwv_flow_api.id(18157965468481805975)
,p_prompt=>'User'
,p_source=>'C##cs347_mc44696'
,p_source_type=>'STATIC'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>255
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18157988690393805987)
,p_name=>'P3_PASS'
,p_item_sequence=>3
,p_item_plug_id=>wwv_flow_api.id(18157965468481805975)
,p_prompt=>'Pass'
,p_source=>'orcl_mc44696'
,p_source_type=>'STATIC'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>255
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18157989430530805988)
,p_name=>'P3_MODE'
,p_item_sequence=>4
,p_item_plug_id=>wwv_flow_api.id(18157965468481805975)
,p_prompt=>'Mode'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18157990264080805989)
,p_name=>'P3_MODEL'
,p_item_sequence=>5
,p_item_plug_id=>wwv_flow_api.id(18157965468481805975)
,p_prompt=>'Model'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18157991067775805990)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18157991804403805990)
,p_name=>'P3_RETURNFOR'
,p_item_sequence=>7
,p_item_plug_id=>wwv_flow_api.id(18157965468481805975)
,p_prompt=>'Returnfor'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18157992612707805991)
,p_name=>'P3_QUERY'
,p_item_sequence=>17
,p_item_plug_id=>wwv_flow_api.id(18157965468481805975)
,p_prompt=>'Query'
,p_source=>'"MATCH (a:pokemon)-[:type]->(b:type) WHERE a.poke_name = ''Pikachu'' RETURN a.poke_id, a.poke_name, b.type, a.descr, a.image"'
,p_source_type=>'STATIC'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>255
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(18157966698188805979)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_WEB_SERVICE'
,p_process_name=>'Web Service Request'
,p_process_sql_clob=>'18155581581585690276:18155581766714690278'
,p_attribute_01=>wwv_flow_api.id(18155581766714690278)
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'MICHAELCANTU93@GMAIL.COM'
,p_last_upd_yyyymmddhh24miss=>'20151123021337'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18165448622638184206)
,p_plug_name=>'New'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(18155472030161683423)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(18062295605959726830)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(18165448622638184206)
,p_button_name=>'BACK'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(18155477866379683441)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18165448707752184207)
,p_name=>'P7_POKEID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(18165448622638184206)
,p_prompt=>'Pokedex Number'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_field_template=>wwv_flow_api.id(18155473342565683433)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18165448819951184208)
,p_name=>'P7_POKENAME'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(18165448622638184206)
,p_prompt=>'Name'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18165448996294184209)
,p_name=>'P7_POKETYPE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(18165448622638184206)
,p_prompt=>'Type'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18165449045778184210)
,p_name=>'P7_DESCR'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(18165448622638184206)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18165449175717184211)
,p_name=>'P7_IMAGE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(18165448622638184206)
...
wwv_flow_api.create_web_service(
 p_id=>wwv_flow_api.id(18155581581585690276)
,p_name=>'RestfulRel'
...
wwv_flow_api.create_ws_operations(
 p_id=>wwv_flow_api.id(18155581766714690278)
,p_ws_id=>wwv_flow_api.id(18155581581585690276)
,p_name=>'doREST'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(18155582008640690282)
,p_ws_opers_id=>wwv_flow_api.id(18155581766714690278)
,p_name=>'query'
,p_input_or_output=>'I'
,p_parm_type=>'string'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18157993049547805991)
,p_parameter_id=>wwv_flow_api.id(18155582008640690282)
,p_process_id=>wwv_flow_api.id(18157966698188805979)
,p_map_type=>'ITEM'
,p_parm_value=>'P3_QUERY'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(18155582305316690283)
,p_ws_opers_id=>wwv_flow_api.id(18155581766714690278)
,p_name=>'json'
,p_input_or_output=>'O'
,p_parm_type=>'json'
...
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(18155615164530694448)
,p_ws_opers_id=>wwv_flow_api.id(18155581766714690278)
,p_name=>'DB'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18157967469255805986)
,p_parameter_id=>wwv_flow_api.id(18155615164530694448)
,p_process_id=>wwv_flow_api.id(18157966698188805979)
,p_map_type=>'ITEM'
,p_parm_value=>'P3_DB'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(18155615452427694449)
,p_ws_opers_id=>wwv_flow_api.id(18155581766714690278)
,p_name=>'USER'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18157988266559805987)
,p_parameter_id=>wwv_flow_api.id(18155615452427694449)
,p_process_id=>wwv_flow_api.id(18157966698188805979)
,p_map_type=>'ITEM'
,p_parm_value=>'P3_USER'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(18155615790292694449)
,p_ws_opers_id=>wwv_flow_api.id(18155581766714690278)
,p_name=>'PASS'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18157989071256805988)
,p_parameter_id=>wwv_flow_api.id(18155615790292694449)
,p_process_id=>wwv_flow_api.id(18157966698188805979)
,p_map_type=>'ITEM'
,p_parm_value=>'P3_PASS'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(18155616019143694449)
,p_ws_opers_id=>wwv_flow_api.id(18155581766714690278)
,p_name=>'MODE'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18157989853215805989)
,p_parameter_id=>wwv_flow_api.id(18155616019143694449)
,p_process_id=>wwv_flow_api.id(18157966698188805979)
,p_map_type=>'ITEM'
,p_parm_value=>'P3_MODE'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(18155616353851694449)
,p_ws_opers_id=>wwv_flow_api.id(18155581766714690278)
,p_name=>'MODEL'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18157990690014805989)
,p_parameter_id=>wwv_flow_api.id(18155616353851694449)
,p_process_id=>wwv_flow_api.id(18157966698188805979)
,p_map_type=>'ITEM'
,p_parm_value=>'P3_MODEL'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(18155616666612694450)
,p_ws_opers_id=>wwv_flow_api.id(18155581766714690278)
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18157991481526805990)
,p_parameter_id=>wwv_flow_api.id(18155616666612694450)
,p_process_id=>wwv_flow_api.id(18157966698188805979)
,p_map_type=>'ITEM'
,p_parm_value=>'P3_RETURNDIMENSIONS'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(18155616979169694450)
,p_ws_opers_id=>wwv_flow_api.id(18155581766714690278)
,p_name=>'returnFor'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18157992273874805991)
,p_parameter_id=>wwv_flow_api.id(18155616979169694450)
,p_process_id=>wwv_flow_api.id(18157966698188805979)
,p_map_type=>'ITEM'
...
wwv_flow_api.create_install(
 p_id=>wwv_flow_api.id(18164083384279277948)
);
end;
/
